...
6. Test to see if you successfully added the bin folder to your path by going to the command promp and typing "ffmpeg"
![image](https://github.com/InfernoCycle/TrueYTtoMP3/assets/105338348/e24ffe45-c2c7-4a54-8ccc-e82bc1221668)

7. After you have done everything above you can now download the executable [here](https://github.com/InfernoCycle/TrueYTtoMP3/releases/download/v1.0.0/YTtoMP3.exe) and run it.
